...
package usuario.servicio.service.persistence;
...
public class UsuarioUtil {
	...
	public static Usuario findByUuid_First(
		...
		throws usuario.servicio.exception.NoSuchUsuarioException {
	 ...
	 */
	public static Usuario create(long userId) {
	 ...
	 * @throws NoSuchUsuarioException if a usuario with the primary key could not be found
	 */
	public static Usuario remove(long userId)
		throws usuario.servicio.exception.NoSuchUsuarioException {
	 ...
	 * @throws NoSuchUsuarioException if a usuario with the primary key could not be found
	 */
	public static Usuario findByPrimaryKey(long userId)
		throws usuario.servicio.exception.NoSuchUsuarioException {
	 ...
	 */
	public static Usuario fetchByPrimaryKey(long userId) {
