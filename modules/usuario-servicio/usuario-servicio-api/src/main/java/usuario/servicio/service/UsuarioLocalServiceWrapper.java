...
package usuario.servicio.service;
...
public class UsuarioLocalServiceWrapper
	 ...
	 */
	@Override
	public usuario.servicio.model.Usuario addUsuario(
		usuario.servicio.model.Usuario usuario) {
	 ...
	 */
	@Override
	public usuario.servicio.model.Usuario createUsuario(long userId) {
	 ...
	 */
	@Override
	public usuario.servicio.model.Usuario deleteUsuario(long userId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public usuario.servicio.model.Usuario deleteUsuario(
		usuario.servicio.model.Usuario usuario) {
	...
	@Override
	public usuario.servicio.model.Usuario fetchUsuario(long userId) {
	 ...
	 */
	@Override
	public usuario.servicio.model.Usuario getUsuario(long userId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<usuario.servicio.model.Usuario> getUsuarios(
		int start, int end) {
	 ...
	 */
	@Override
	public usuario.servicio.model.Usuario updateUsuario(
		usuario.servicio.model.Usuario usuario) {
