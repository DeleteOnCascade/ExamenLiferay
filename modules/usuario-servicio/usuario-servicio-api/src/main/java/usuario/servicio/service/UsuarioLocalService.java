...
public interface UsuarioLocalService
	...
	public Usuario deleteUsuario(long userId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Usuario fetchUsuario(long userId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Usuario getUsuario(long userId) throws PortalException;
